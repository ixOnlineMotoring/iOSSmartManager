    ...
    if (arraySliderImages.count==0)
    {
        switch (indexPath.row)
        {
            ...
            case 1:
            {
                ...
                cell.lblVehicle44.text   = @"Offer Date:";
                cell.lblVehicle55.text   = @"Offer Start:";
                cell.lblVehicle66.text   = @"Offer End:";
                ...
                cell.lblVehicle4.text   = self.objectVehicleListing.strOfferDate;
                cell.lblVehicle5.text   = self.objectVehicleListing.strOfferStart;
                cell.lblVehicle6.text   = self.objectVehicleListing.strOfferEnd;
