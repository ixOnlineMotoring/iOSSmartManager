...
@interface QBAssetsCollectionViewController : UICollectionViewController <UICollectionViewDelegateFlowLayout, UIGestureRecognizerDelegate,MBProgressHUDDelegate>
{
    // need to add the selected photos count.
    BOOL isAlertShownOnce;
    BOOL isSmallImageSelected;
    NSIndexPath *selectedIndexRow;
    int photosLeft;
     MBProgressHUD *HUD;
}
