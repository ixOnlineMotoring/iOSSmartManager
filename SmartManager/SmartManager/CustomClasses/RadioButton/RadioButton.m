...
-(id)initWithGroupId:(NSString*)groupId index:(NSUInteger)index withTitle:(NSString *)strTitleText{
...
-(void)defaultInit{
    ...
    _button.titleLabel.font = [UIFont fontWithName:FONT_NAME size:14.0f];// Button Font Name
    [_button setImage:[UIImage imageNamed:@"radio_off"] forState:UIControlStateNormal];
    [_button setImage:[UIImage imageNamed:@"radio_on"] forState:UIControlStateSelected];
    [_button setTitle:strTitle forState:UIControlStateNormal];
