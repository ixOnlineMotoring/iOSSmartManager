...
+(void)AttributeStringMethodwithFontWithLabel:(UILabel*)label moduleName:(NSString*)strModuleName
{
    ...
    if ([strModuleName isEqualToString:@"Social"])
    {
        fontID = 445;
    }
    else if ([strModuleName isEqualToString:@"Wanted"])
    {
        fontID = 34;
    }
    
    else if ([strModuleName isEqualToString:@"Vehicles"])
    {
         fontID = 41;
    }
    else if ([strModuleName isEqualToString:@"Trader"])
    {
         fontID = 458;
    }
    else if ([strModuleName isEqualToString:@"Buy"])
    {
         fontID = 467;
    }
    else if ([strModuleName isEqualToString:@"Sell"])
    {
         fontID = 248;
    }
    else if ([strModuleName isEqualToString:@"My Bids"])
    {
         fontID = 336;
    }
    else if ([strModuleName isEqualToString:@"Delivery"])
    {
        fontID = 128;
    }
    ...
    else if ([strModuleName isEqualToString:@"VIN Lookup"])
    {
         fontID = 47;
    }
    else if ([strModuleName isEqualToString:@"Load Vehicle"])
    {
         fontID = 571;
    }
    else if ([strModuleName isEqualToString:@"Stock List"])
    {
         fontID = 450;
    }
    else if ([strModuleName isEqualToString:@"Edit Stock"] || [strModuleName isEqualToString:@"List"])
    {
        fontID = 401;
    }
    else if ([strModuleName isEqualToString:@"Specials"])
    {
         fontID = 524;
    }
    else if ([strModuleName isEqualToString:@"To Do's"])
    {
         fontID = 525;
    }
    else if ([strModuleName isEqualToString:@"Log Activity"])
    {
         fontID = 118;
    }
    else if ([strModuleName isEqualToString:@"New Task"])
    {
         fontID = 419;
    }
    else if ([strModuleName isEqualToString:@"Tasks by Me"])
    {
         fontID = 302;
    }
    else if ([strModuleName isEqualToString:@"Blog Post"])
    {
        fontID = 454;
    }
    else if ([strModuleName isEqualToString:@"Planner"])
    {
        fontID = 85;
    }
    else if ([strModuleName isEqualToString:@"Notifications"])
    {
        fontID = 58;
    }
    else if ([strModuleName isEqualToString:@"Leads"])
    {
        fontID = 46;
    }
    else if ([strModuleName isEqualToString:@"Unseen"])
    {
        fontID = 79;
    }
    else if ([strModuleName isEqualToString:@"Customers"])
    {
        fontID = 573;
    }
    else if ([strModuleName isEqualToString:@"Stock Audit"])
    {
        fontID = 1;
    }
    else if ([strModuleName isEqualToString:@"Scan License"])
    {
        fontID = 47;
    }
    else if ([strModuleName isEqualToString:@"E-Brochure"] || [strModuleName isEqualToString:@"Send Brochure"] || [strModuleName isEqualToString:@"eBrochure"])
    {
        fontID = 454;
    }
    else if ([strModuleName isEqualToString:@"Vehicle Alerts"])
    {
        fontID = 190;
    }
    else if ([strModuleName isEqualToString:@"Trade Partners"])
    {
        fontID = 472;
    }
    else if ([strModuleName isEqualToString:@"Settings"])
    {
        fontID = 145;
    }
    else if ([strModuleName isEqualToString:@"Losing Bids"])
    {
        fontID = 70;
    }
    else if ([strModuleName isEqualToString:@"Winning Bids"])
    {
        fontID = 173;
    }
    else if ([strModuleName isEqualToString:@"Auto Bidding"])
    {
        fontID = 195;
    }
   
    else if ([strModuleName isEqualToString:@"Won"])
    {
        fontID = 115;
    }
    else if ([strModuleName isEqualToString:@"Private Offers"])
    {
        fontID = 324;
    }
    else if ([strModuleName isEqualToString:@"Withdrawn"])
    {
        fontID = 185;
    }
    else if ([strModuleName isEqualToString:@"Cancelled"])
    {
        fontID = 227;
    }
    else if ([strModuleName isEqualToString:@"Bidding Ended"])
    {
        fontID = 135;
    }
    else if ([strModuleName isEqualToString:@"Bids Received"])
    {
        fontID = 119;
    } else if ([strModuleName isEqualToString:@"Trade Vehicles"])
    {
        fontID = 457;
    }
    else if ([strModuleName isEqualToString:@"Sales"])
    {
        fontID = 539;
    } else if ([strModuleName isEqualToString:@"Missing Price"])
    {
        fontID = 232;
    } else if ([strModuleName isEqualToString:@"Activate Retail"])
    {
        fontID = 373;
    } else if ([strModuleName isEqualToString:@"Missing Info"])
    {
        fontID = 188;
    } else if ([strModuleName isEqualToString:@"My Buyers"])
    {
        fontID = 191;
    } else if ([strModuleName isEqualToString:@"My Sellers"])
    {
        fontID = 154;
    } else if ([strModuleName isEqualToString:@"Readiness"])
    {
        fontID = 480;
    }
    else if ([strModuleName isEqualToString:@"Auctions"])
    {
        fontID = 308;
    }
    else if ([strModuleName isEqualToString:@"Lost"])
    {
        fontID = 541;
    }
    else if ([strModuleName isEqualToString:@"Display"])
    {
        fontID = 169;
    }
    else if ([strModuleName isEqualToString:@"Trade Price"])
    {
        fontID = 572;
    }
    else if ([strModuleName isEqualToString:@"Members"])
    {
        fontID = 349;
    }
    else if ([strModuleName isEqualToString:@"Custom Msgs"])
    {
        fontID = 599;
    }
    else if ([strModuleName isEqualToString:@"Synopsis"])
    {
        fontID = 161;
    }
    /////////////////Monami /////////////////////////////////////////////
    ///////// Add new Module Support ///////////////////////////////////
    else if ([strModuleName isEqualToString:@"Support"])
    {
        fontID = 535;
    }
    else if ([strModuleName isEqualToString:@"Support Request"])
    {
        fontID = 535;
    }
    /////////////////////// END //////////////////////////////////////
    else if ([strModuleName isEqualToString:@"Scan VIN"])
    {
        fontID = 47;
    }
    else if ([strModuleName isEqualToString:@"Vehicle Lookup"])
    {
        fontID = 195;
    }
    else if ([strModuleName isEqualToString:@"Vehicle Code"])
    {
        fontID = 140;
    }
    else if ([strModuleName isEqualToString:@"Vehicle in Stock"])
    {
        fontID = 164;
    }
    else if ([strModuleName isEqualToString:@"Stock Summary"])
    {
        fontID = 173;
    }
    else if ([strModuleName isEqualToString:@"Saved Appraisals"])
    {
        fontID = 238;
    }
    ...
    {
        [label setFont:[UIFont fontWithName:kFontAwesomeFamilyName size:50]];
    }
    else
    {
        [label setFont:[UIFont fontWithName:kFontAwesomeFamilyName size:80]];
    }
    
    [label setText:[NSString fontAwesomeIconStringForIconIdentifier:[self.iconIdentiferArray objectAtIndex:fontID]]];
}
...
+(void)AttributeStringMethodwithFontWithButton:(UIButton*)button iconID:(int)iconID
{
    if (iconID==22)
    {
        if (UI_USER_INTERFACE_IDIOM()==UIUserInterfaceIdiomPhone)
        {
            [button.titleLabel setFont:[UIFont fontWithName:kFontAwesomeFamilyName size:25]];
        }
        else
        {
            [button.titleLabel setFont:[UIFont fontWithName:kFontAwesomeFamilyName size:35]];
        }
    }
    if (iconID==24)
    {
    ...
    if (iconID==458) // if (iconID==376)
    {
        
       // [attributedString addAttribute:NSFontAttributeName value:[UIFont fontWithName:kFontAwesomeFamilyName size:25] range:NSMakeRange(0, 1)];
    ...
    if (iconID==370)
    {
        ...
        {
            [button.titleLabel setFont:[UIFont fontWithName:kFontAwesomeFamilyName size:55]];
        }
    }
    if (iconID==450)
    {
    ...
    if (iconID==85)
    {
        [button.titleLabel setFont:[UIFont fontWithName:kFontAwesomeFamilyName size:15]];
    }
    ...
    if (iconID==289)
    {
        if (UI_USER_INTERFACE_IDIOM()==UIUserInterfaceIdiomPhone)
        {
            [button.titleLabel setFont:[UIFont fontWithName:kFontAwesomeFamilyName size:45]];
        }
        else
        {
            [button.titleLabel setFont:[UIFont fontWithName:kFontAwesomeFamilyName size:55]];
    ...
    {
        [button.titleLabel setFont:[UIFont fontWithName:kFontAwesomeFamilyName size:30]];
    }
    
    [button setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    
    [button setTitle:[NSString fontAwesomeIconStringForIconIdentifier:[self.iconIdentiferArray objectAtIndex:iconID]] forState:UIControlStateNormal];
}
...
+(void)AttributeStringMethodwithFontWithButtonForLogin:(UIButton*)button iconID:(int)iconID
{
    ...
    {
        [button.titleLabel setFont:[UIFont fontWithName:kFontAwesomeFamilyName size:40]];
    }
...
+(void)AttributeStringMethodwithFontWithLabelForLogin:(UILabel*)label iconID:(int)iconID
{
    ...
    {
       // [button.titleLabel setFont:[UIFont fontWithName:kFontAwesomeFamilyName size:20]];
        label.font = [UIFont fontWithName:kFontAwesomeFamilyName size:50];
        
    }
    else
    {
        label.font = [UIFont fontWithName:kFontAwesomeFamilyName size:40];

    }
    
    label.textColor = [UIColor whiteColor];
    label.text = [NSString fontAwesomeIconStringForIconIdentifier:[self.iconIdentiferArray objectAtIndex:iconID]];
...
{
    NSMutableAttributedString *attributedString = [[NSMutableAttributedString alloc] initWithString:[NSString fontAwesomeIconStringForIconIdentifier:[self.iconIdentiferArray objectAtIndex:iconID]]];
    ...
    if (iconID==450)
    {
        if (UI_USER_INTERFACE_IDIOM()==UIUserInterfaceIdiomPhone)
        {
            ...
            [attributedString addAttribute:NSFontAttributeName value:[UIFont fontWithName:kFontAwesomeFamilyName size:35] range:NSMakeRange(0, 1)];
        }
        else
        {
            [button.titleLabel setFont:[UIFont fontWithName:kFontAwesomeFamilyName size:55]];
            
            [attributedString addAttribute:NSFontAttributeName value:[UIFont fontWithName:kFontAwesomeFamilyName size:55] range:NSMakeRange(0, 1)];
        }
    }
