//
//  SMSellListDetailsViewController.m
//  SmartManager
//
...
@interface SMSellListDetailsViewController ()

@end

@implementation SMSellListDetailsViewController
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    NSLog(@"self.lblVehicleNameN.text = %@",self.lblVehicleNameN.text);
    ...
    [self.lblVehicleNameN setAttributedText:stringN];
   ...
   // self.lblVehicleMileage.text   = [NSString stringWithFormat:@"%@ Km",[[SMCommonClassMethods shareCommonClassManager] mileageConvertEn_AF:self.objectVehicleListing.strVehicleMileage]];
    ...
    self.lblVehicleMileage.text   = self.objectVehicleListing.strVehicleMileage;
  ...
  //  self.lblVehicleMileageN.text   = [NSString stringWithFormat:@"%@ Km",[[SMCommonClassMethods shareCommonClassManager] mileageConvertEn_AF:self.objectVehicleListing.strVehicleMileage]];
     ...
     self.lblVehicleMileageN.text   = self.objectVehicleListing.strVehicleMileage;
...
- (void)viewDidLoad
{
    ...
    arrayListVehicles = [[NSMutableArray alloc]init];
...
- (void)registerNib
{
   [self.collectionView registerNib:[UINib nibWithNibName:UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPhone ? @"SMSellCollectionCell" : @"SMSellCollectionCell_iPad" bundle:nil]            forCellWithReuseIdentifier:@"SMSellCollectionCellIdentifier"];
    ...
    [self.tblViewSellList registerNib:[UINib nibWithNibName:UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPhone ? @"SMSellListDetailCell" : @"SMSellListDetailCell_iPad" bundle:nil] forCellReuseIdentifier:@"SMSellListDetailCellIdentifier"];
}
    ...
    switch (indexPath.row)
    {
        case 0:
        {
            ...
            if(arrayImages.count == 0)
            {
                ...
                {
                    [cell.contentView addSubview:self.viewHeaderContainerNoImage_iPad];
        ...
        case 1:
            if (arraySliderImages.count==0)
            {
                ...
                cell.lblVehicle3.text   = self.objectVehicleListing.strOfferAmount;
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        case 0:
            return (UI_USER_INTERFACE_IDIOM()==UIUserInterfaceIdiomPhone) ? 106.0f : 130.0f;
            break;
...
- (void)parser:(NSXMLParser *)parser didEndElement:(NSString *)elementName namespaceURI:(NSString *)namespaceURI qualifiedName:(NSString *)qName
{
    ...
    {
        self.objectVehicleListing.strLocation = currentNodeContent;
        
        if([self.objectVehicleListing.strLocation length] == 0)
            self.objectVehicleListing.strLocation = @"Location?";
...
- (void)parserDidEndDocument:(NSXMLParser *)parser
{
    dispatch_async(dispatch_get_main_queue(), ^{
        [self hideProgressHUD];
        [self.tblViewSellList reloadData];
