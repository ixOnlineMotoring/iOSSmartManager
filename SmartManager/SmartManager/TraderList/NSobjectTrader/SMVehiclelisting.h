...
@property(nonatomic, strong) NSString *strVehicleRegNo;
...
@property(nonatomic, strong) NSString *strContactperson;
@property(nonatomic, strong) NSString *strClientIdForBuyerSummary;

@property(nonatomic, strong) NSString *strSalesCount;
@property(nonatomic, strong) NSString *strClientPhoneNumber;
...
@property(nonatomic)         BOOL      isAnyOneBidSelected;
...
@property(nonatomic, strong) NSString * strWinningBid;
@property(nonatomic, strong) NSString * strMyBid;
@property(nonatomic, strong) NSString * strMinBid;
@property(nonatomic, strong) NSString * strAskingPrice;
@property(nonatomic, strong) NSString *strOfferedPrice;
...
@property(nonatomic, strong) NSString *priceCurrent;
@property(nonatomic, strong) NSString *priceCap;
@property(nonatomic, strong) NSString *priceIncrement;
