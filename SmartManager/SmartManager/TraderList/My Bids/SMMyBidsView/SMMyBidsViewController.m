...
- (void)viewDidLoad
{
    ...
    NSString*(^getDateToLastMonthDate)(void) = ^NSString*(void){
        ...
        NSDate *lastMonthDate = [cal dateByAddingComponents:comps toDate:endDate options:0];
    ...
    if (UI_USER_INTERFACE_IDIOM()==UIUserInterfaceIdiomPhone)
    {
        ...
        self.lblTo.font                   = [UIFont fontWithName:FONT_NAME size:15.0f];
    }
    else
    {
        ...
        self.lblTo.font                   = [UIFont fontWithName:FONT_NAME size:20.0f];
    }
        ...
        switch (currentIndex)
        {
            case 0:
                ...
                if (sectionObject.isExpanded)
                {
                    ...
                    {
                        [self.arrayLosingBid removeAllObjects];
                        [self webServiceForLosingBid];
                    }
                    else
                        nil;
            ...
            case 1:
                ...
                if (sectionObject.isExpanded)
                {
                    ...
                    {
                        [self.arrayWinningBid removeAllObjects];
                        [self webServiceForWinningBid];
                    }
                    else
                        nil;
