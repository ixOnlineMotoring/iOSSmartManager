...
#define WEB_SERVICE_QASERVER_STAGING @"qa.ix.co.za"


+ (NSString*) uploadVideosWebserviceUrl
{
    
    return [NSString stringWithFormat:@"http://uploadservice.%@/api/Video",WEB_SERVICE_QASERVER_STAGING];
}

+(NSString *)blogImageUrl
{
    return [NSString stringWithFormat:@"http://netwin.%@/",WEB_SERVICE_QASERVER_STAGING];
}

+(NSString*)authenticateWebserviceUrl
{
    
    return [NSString stringWithFormat:@"http://p4authentication.%@/Authenticate.svc",WEB_SERVICE_QASERVER_STAGING];
}
...
{
    return [NSString stringWithFormat:@"http://planner.%@/PlannerService.svc",WEB_SERVICE_QASERVER_STAGING];
    
}

+(NSString*)blogWebserviceUrl
{
    return [NSString stringWithFormat:@"http://blog.%@/BlogService.svc",WEB_SERVICE_QASERVER_STAGING];
}

+(NSString *)stockWebService
{
    return [NSString stringWithFormat:@"http://stock.%@/StockService.svc",WEB_SERVICE_QASERVER_STAGING];
}

+(NSString *)tradeWebService
{
    return [NSString stringWithFormat:@"http://tradeservice.%@/TradeService.svc",WEB_SERVICE_QASERVER_STAGING];
}

+(NSString *)leadWebService
{
    
    return [NSString stringWithFormat:@"http://lead.%@/LeadService.svc",WEB_SERVICE_QASERVER_STAGING];
}

+(NSString *)eBrochureWebService
{
    return [NSString stringWithFormat:@"http://ebrochure.%@/ElectronicBrochureGeneratorService.svc",WEB_SERVICE_QASERVER_STAGING];
}
...
{
    return [NSString stringWithFormat:@"http://licensesvc.%@/License.svc",WEB_SERVICE_QASERVER_STAGING];
}
