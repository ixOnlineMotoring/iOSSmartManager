...
@implementation SMSynopsisXMLResultObject
-(id) init
{
//    
...
//    @property (strong, nonatomic)NSString *strCondition;
    ...
    if(self=[super init])
    {
        self.strVariantImage = @"";
        self.strMakeName = @"";
        self.strModelName = @"";
        self.strVariantName = @"";
        self.strFriendlyName = @"";
        self.strMMCode = @"";
        self.strTransmission = @"";
        self.strStartDate = @"";
        self.strEndDate = @"";
        self.strVariantDetails = @"";
        self.strVINNo = @"";
        self.strKilometers = @"";
        self.strFuel_Type = @"";
        self.strGearbox = @"";
        self.pricingTraderPrice = @"";
        self.pricingRetailPrice = @"";
        self.pricingPrivateAdvertPrice = @"";
        self.pricingSLTradePrice = @"";
        self.pricingSLRetailPrice = @"";
        self.strTUASearchDateTime = @"";
        self.strRegNo = @"";
    }
    return self;
}
